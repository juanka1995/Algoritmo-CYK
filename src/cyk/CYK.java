...
//                    System.out.println("2: " + miMatriz.get(i-k-1).get(j+k+1) + " ["+(i-k-1)+"]["+(j+k+1)+"]");
    ...
    public static boolean algoritmoCYK_IG(ArrayList<ArrayList<String>> miMatriz, String palabra, Gramatica miGramatica, ArrayList<ArrayList<ArrayList<String>>> vectorMatrices){
        boolean pertenece = false;
        String values = new String();
        int n = miMatriz.size();
...
//                    System.out.println("2: " + miMatriz.get(i-k-1).get(j+k+1) + " ["+(i-k-1)+"]["+(j+k+1)+"]");
                ...
                miMatriz.get(i).set(j, values);
                vectorMatrices.add(copyMatrix(miMatriz));
//                mostrarMatriz(vectorMatrices.get(i));
            }
        }
